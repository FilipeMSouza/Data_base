...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            ...
            <td class="text-center">
                <a class="btn btn-danger" href="./pages/delete/conserto.php?id=<?php echo $conserto['placa']?>">Remover</button>
                <a class="btn btn-primary"  href="./pages/update/conserto.php?id=<?php echo $conserto['placa']?>">Editar</button>
            </td>
        </tr>        
    </tbody>
    <?php endforeach;?>
